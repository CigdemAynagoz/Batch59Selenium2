...
//  13-En son adim olarak butun sayfalarimizi kapatmis olalim
    public static void main(String[] args) throws InterruptedException {
        ...
        //  6-bu web adresinin sayfa basligini(title) ve adres(url)ini alalim
        String sahbndnTitle = driver.getTitle();
        System.out.println("sahbndnTitle = " + sahbndnTitle);

        String sahbndnUrl = driver.getCurrentUrl();
    System.out.println("sahbndnUrl = " + sahbndnUrl);

        //  7-title ve url'nin "Oto" kelimesinin icerip icermedigini kontrol edelim
        if (sahbndnTitle.contains("Oto")&&sahbndnUrl.contains("Oto")){
            System.out.println("oto yazısı icerir");
        }else {
            System.out.println("oto yazısı icermez");
        }
